	...
	?>
        ...
        <table class="wp-list-table widefat fixed posts youtube_settings_table" style="width: 640px; min-width:320px !important;table-layout: fixed;">
            ...
            <tbody>
                ...
                <tr>
                    <td>     
                    	Autoplay <span title="Set this option for automatically start playing videos when users open the page the video replaced" class="desription_class">?</span>
                    </td>
                ...
                <tr>
                 ...
                 <tr>
                    <td>     
                    	Autohide Parameters <span title="Set this option if you want automatically hide YouTube player parameters" class="desription_class">?</span>
                    </td>
                ...
                <tr>
                    <td>     
                    	Initial Volume <span title="Set Initial Volume level for YouTube videos" class="desription_class">?</span>
                    </td>
                    <td>     
