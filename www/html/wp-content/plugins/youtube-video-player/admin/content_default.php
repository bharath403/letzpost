        ...
        <table class="wp-list-table widefat fixed posts youtube_settings_table" style="width: 640px; min-width:320px !important;table-layout: fixed;">
            ...
            <tbody>
                ...
                <tr>
                 ...
                 <tr>
                    <td>     
                    	Autohide Parameters: <span title="Set this option if you need Autohide Parameters" class="desription_class">?</span>
                    </td>
                ...
                <tr>
                    <td>     
                    	Initial Volume Level: <span title="Choose initial volume level for YouTube videos" class="desription_class">?</span>
                    </td>
                    <td>     
